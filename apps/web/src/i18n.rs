...
pub fn init_i18n() -> I18nContext {
    ...
    // Channels (QwenPaw-style)
    zh.insert("channels-filter-all", "全部");
    zh.insert("channels-filter-builtin", "内置");
    zh.insert("channels-filter-custom", "自定义");
    zh.insert("channels-loading", "加载中...");
    zh.insert("channels-empty", "暂无频道");
    zh.insert("channels-status-enabled", "已启用");
    zh.insert("channels-status-disabled", "未启用");
    zh.insert("channels-chip-builtin", "内置");
    zh.insert("channels-chip-custom", "自定义");
    zh.insert("channels-not-set", "未设置");
    zh.insert("channels-settings", "设置");
    zh.insert("channels-basic-settings", "基础设置");
    zh.insert("channels-enabled", "启用");
    zh.insert("channels-bot-prefix", "Bot 前缀");
    zh.insert("channels-filter-tool", "过滤工具消息");
    zh.insert("channels-filter-thinking", "过滤思考过程");
    zh.insert("channels-platform-fields", "平台专属字段");
    zh.insert("channels-base-url", "Base URL");
    zh.insert("channels-bot-token", "Bot Token");
    zh.insert("channels-client-id", "Client ID");
    zh.insert("channels-client-secret", "Client Secret");
    zh.insert("channels-message-type", "消息类型");
    zh.insert("channels-msg-type-text", "文本");
    zh.insert("channels-msg-type-markdown", "Markdown");
    zh.insert("channels-app-id", "App ID");
    zh.insert("channels-app-secret", "App Secret");
    zh.insert("channels-region", "区域");
    zh.insert("channels-region-china", "中国");
    zh.insert("channels-region-intl", "国际");
    zh.insert("channels-bot-id", "Bot ID");
    zh.insert("channels-bot-secret", "Bot Secret");
    zh.insert("channels-auto-reconnect", "自动重连");
    zh.insert("channels-webhook-url", "Webhook URL");
    zh.insert("channels-api-key", "API Key");
    zh.insert("channels-account-sid", "Account SID");
    zh.insert("channels-auth-token", "Auth Token");
    zh.insert("channels-phone-number", "电话号码");
    zh.insert("channels-qrcode-auth", "二维码认证");
    zh.insert("channels-qr-code", "二维码");
    zh.insert("channels-qr-confirmed", "扫码成功");
    zh.insert("channels-qr-scanned", "已扫码");
    zh.insert("channels-qr-expired", "已过期");
    zh.insert("channels-qr-waiting", "等待扫码...");
    zh.insert("channels-refresh-qr", "刷新二维码");
    zh.insert("channels-get-qr", "获取二维码");
    zh.insert("channels-access-control", "访问控制");
    zh.insert("channels-dm-policy", "私聊策略");
    zh.insert("channels-group-policy", "群聊策略");
    zh.insert("channels-policy-open", "开放");
    zh.insert("channels-policy-allowlist", "白名单");
    zh.insert("channels-require-mention", "需要 @提及");
    zh.insert("channels-allow-from", "允许来源");
    zh.insert("channels-bot-base-url", "Bot 基础 URL");
    zh.insert("channels-message-merge", "消息合并");
    zh.insert("channels-merge-delay", "合并延迟（毫秒）");
    zh.insert("channels-reconnect-interval", "重连间隔（秒）");
    zh.insert("channels-warning-before", "过期前警告（秒）");
    zh.insert("channels-force-before", "强制重连阈值（秒）");
    zh.insert("channels-media-dir", "媒体下载目录");
    zh.insert("channels-show-tool", "显示工具消息");
    zh.insert("channels-show-thinking", "显示思考过程");
    zh.insert("channels-scan-login", "扫码登录");
    zh.insert("channels-ilink-desc", "微信个人账号 Bot（iLink 协议）。首次启动时若未配置 Bot Token，系统将打印二维码链接，请扫码登录；Token 将自动保存到本地文件供后续使用。");
    zh.insert("channels-ilink-warning", "微信 iLink 平台限制：每条用户消息对应的 context_token 最多只能回复 10 条消息，这是平台侧的硬性限制，无法突破。建议关闭思考及工具输出，避免超出限制导致消息发送失败。");
    zh.insert("channels-token-file-path", "Token 文件路径");
    zh.insert("channels-white-list", "白名单用户");
    zh.insert("channels-white-list-placeholder", "输入用户ID后按回车添加");
    zh.insert("channels-weixin-doc", "微信 Doc");
    zh.insert("channels-qr-scan-tip", "请用微信扫描二维码，扫码成功后点击保存");
    ...
    // Channels (QwenPaw-style)
    en.insert("channels-filter-all", "All");
    en.insert("channels-filter-builtin", "Built-in");
    en.insert("channels-filter-custom", "Custom");
    en.insert("channels-loading", "Loading...");
    en.insert("channels-empty", "No channels");
    en.insert("channels-status-enabled", "Enabled");
    en.insert("channels-status-disabled", "Disabled");
    en.insert("channels-chip-builtin", "Built-in");
    en.insert("channels-chip-custom", "Custom");
    en.insert("channels-not-set", "Not set");
    en.insert("channels-settings", "Settings");
    en.insert("channels-basic-settings", "Basic Settings");
    en.insert("channels-enabled", "Enabled");
    en.insert("channels-bot-prefix", "Bot Prefix");
    en.insert("channels-filter-tool", "Filter Tool Messages");
    en.insert("channels-filter-thinking", "Filter Thinking");
    en.insert("channels-platform-fields", "Platform-specific Fields");
    en.insert("channels-base-url", "Base URL");
    en.insert("channels-bot-token", "Bot Token");
    en.insert("channels-client-id", "Client ID");
    en.insert("channels-client-secret", "Client Secret");
    en.insert("channels-message-type", "Message Type");
    en.insert("channels-msg-type-text", "Text");
    en.insert("channels-msg-type-markdown", "Markdown");
    en.insert("channels-app-id", "App ID");
    en.insert("channels-app-secret", "App Secret");
    en.insert("channels-region", "Region");
    en.insert("channels-region-china", "China");
    en.insert("channels-region-intl", "International");
    en.insert("channels-bot-id", "Bot ID");
    en.insert("channels-bot-secret", "Bot Secret");
    en.insert("channels-auto-reconnect", "Auto Reconnect");
    en.insert("channels-webhook-url", "Webhook URL");
    en.insert("channels-api-key", "API Key");
    en.insert("channels-account-sid", "Account SID");
    en.insert("channels-auth-token", "Auth Token");
    en.insert("channels-phone-number", "Phone Number");
    en.insert("channels-qrcode-auth", "QR Code Authentication");
    en.insert("channels-qr-code", "QR Code");
    en.insert("channels-qr-confirmed", "Scan Confirmed");
    en.insert("channels-qr-scanned", "Scanned");
    en.insert("channels-qr-expired", "Expired");
    en.insert("channels-qr-waiting", "Waiting for scan...");
    en.insert("channels-refresh-qr", "Refresh QR Code");
    en.insert("channels-get-qr", "Get QR Code");
    en.insert("channels-access-control", "Access Control");
    en.insert("channels-dm-policy", "DM Policy");
    en.insert("channels-group-policy", "Group Policy");
    en.insert("channels-policy-open", "Open");
    en.insert("channels-policy-allowlist", "Allowlist");
    en.insert("channels-require-mention", "Require Mention");
    en.insert("channels-allow-from", "Allow From");
    en.insert("channels-bot-base-url", "Bot Base URL");
    en.insert("channels-message-merge", "Message Merge");
    en.insert("channels-merge-delay", "Merge Delay (ms)");
    en.insert("channels-reconnect-interval", "Reconnect Interval (sec)");
    en.insert("channels-warning-before", "Warning Before Expiry (sec)");
    en.insert("channels-force-before", "Force Reconnect Before (sec)");
    en.insert("channels-media-dir", "Media Directory");
    en.insert("channels-show-tool", "Show Tool Messages");
    en.insert("channels-show-thinking", "Show Thinking Process");
    en.insert("channels-scan-login", "Scan to Login");
    en.insert("channels-ilink-desc", "WeChat personal account Bot (iLink protocol). If Bot Token is not configured on first startup, the system will print a QR code link; please scan to login. Token will be automatically saved to a local file for future use.");
    en.insert("channels-ilink-warning", "WeChat iLink platform limit: each user message's context_token can only reply to at most 10 messages. This is a hard limit from the platform side and cannot be bypassed. It is recommended to disable thinking and tool output to avoid exceeding the limit and causing message send failures.");
    en.insert("channels-token-file-path", "Token File Path");
    en.insert("channels-white-list", "Whitelist Users");
    en.insert("channels-white-list-placeholder", "Enter user ID and press Enter to add");
    en.insert("channels-weixin-doc", "WeChat Doc");
    en.insert("channels-qr-scan-tip", "Please scan the QR code with WeChat, then click Save after successful scan");
